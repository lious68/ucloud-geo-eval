...
| 指标 | 说明 | 计算公式 | 权重 |
|------|------|---------|------|
| **提及率** | UCloud 被提及的响应比例 |  UCloud 被提及的有效响应数 / 有效响应总数 | 30% |
| **引用率** | 包含 UCloud 引用/链接的响应比例 | 含UCloud引用的响应数 / 有效响应总数 | 20% |
| **TOP3推荐率** | UCloud 进入前三推荐位的响应比例 | UCloud进入前三推荐位的相应次数 / 有效问题回答总数 | 25% |
